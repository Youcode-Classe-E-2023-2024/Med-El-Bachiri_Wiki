        ...
        <div class="space-y-6 md:space-y-10 mt-10">
            ...
            <div id="menu" class="flex flex-col space-y-2">
                ...
                <div
                        onclick="showCatDiv()"
                        href=""
                        class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-purple-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                >
                    <svg
                ...
                <div
                        onclick=""
                        href=""
                        class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-purple-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
                >
                    <svg
                            class="w-6 h-6 fill-current inline-block"
                            fill="currentColor"

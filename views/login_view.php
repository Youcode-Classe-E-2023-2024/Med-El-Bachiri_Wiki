...
<div class="h-screen md:flex">
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white" id="loginForm">
            ...
            <p id="loginErrMessage" class="text-sm font-normal text-red-500 mb-7"></p>
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <input class="pl-2 outline-none border-none" type="email" name="loginEmail" id="" placeholder="Email Address" />
            </div>
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <input class="pl-2 outline-none border-none" type="password" name="loginPassword" id="" placeholder="Password" />
            </div>

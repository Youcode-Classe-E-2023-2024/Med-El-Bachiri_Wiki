...
<div class="h-screen md:flex">
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form id="registerForm" class="bg-white w-96">
            <h1 class="text-gray-800 font-bold text-2xl mb-1 w-96">Create an Account!</h1>

            <p id="err_message" class="text-red-400 text-sm"></p>
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <input class="pl-2 w-full outline-none border-none" type="text" name="username" id="" placeholder="Username" />
            </div>
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
                     viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input class="pl-2 w-full outline-none border-none" type="email" name="email" id="" placeholder="Enter your Gmail" />
            </div>
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <label for=""></label><input class="pl-2 w-full outline-none border-none" type="password" name="password" id="" placeholder="Password" />
            </div>
